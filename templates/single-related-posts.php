  ...
  <div class="related_posts clearfix">
     ...
     <div class="clearfix related_posts-title-area ">
          ...
          <ul itemscope itemtype="http://schema.org/Thing">
           <?php if($rec->have_posts()) : ?> <li class='recent active' data-val="recent"><span itemprop="name" ><?php _e('Recent','ioa') ?></span> <div class="hoverdir-wrap"><span class="hoverdir"></span></div></li><?php endif; ?>
           <?php if($rel->have_posts()) : ?><li class='related ' data-val="related"><span itemprop="name"><?php _e('Related','ioa'); ?></span> <div class="hoverdir-wrap"><span class="hoverdir"></span></div></li> <?php endif; ?>
      ...
      while ($rel->have_posts()) : $rel->the_post();   $i++; ?>
        ...
        <li class="clearfix <?php if($i==4) echo 'last'; ?>" itemscope itemtype="http://schema.org/Article" >
          ...
          <div class="image">
            ...
            <a class="hover"  href="<?php the_permalink() ?>" style='background-color:<?php echo get_post_meta(get_the_ID(),'dominant_bg_color',true) ?>;'>
