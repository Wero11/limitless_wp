...
$meta_data['hasFeaturedImage'] = false; 
	if ((function_exists('has_post_thumbnail')) && (has_post_thumbnail()))  $meta_data['hasFeaturedImage'] = true; 	?>
        ...
        <li  itemscope itemtype="http://schema.org/Article" data-dbg='<?php echo $dbg; ?>' data-dc='<?php echo $dc; ?>' id="post-<?php the_ID(); ?>"  class=" clearfix <?php echo join(' ',$cl); ?>  <?php echo $meta_data['column']; ?> <?php $meta_data['i']++; ?>">
          <div class="inner-item-wrap">
            ...
            ?>
              ...
              <?php if($meta_data['custom_enable_thumbnail']!="true"): ?>
