...
require_once(HPATH.'/visual_settings.php');
...
<head> <!-- Start of head  -->
	...
	<title><?php _e('Styler MODE: ','ioa') ?> <?php echo get_the_title($_GET['pid']);  ?></title>
    ...
    <script>
    	...
    	var enigma_source = "<?php $id=get_option('page_on_front'); if(isset($_GET['pid'])) $id = $_GET['pid']; echo get_permalink($id); ?>";
	...
	<div class="inner_enigma_sidebar clearfix" >
		...
		<div id="parent_enigma_tab">
			...
			<div id="enigma_visual_mode">
				...
				<div class="info">
					<?php _e('Current Style is ','ioa') ?><strong><?php echo $templates[$default]; ?></strong>
