...
<div data-type="<?php echo $meta_data['widget']['type']; ?>" id="<?php if(isset($meta_data['id'])) echo $meta_data['id']; ?>" data-fields="<?php echo $keys; ?>" class="<?php echo $joint ?>-wrapper page-rad-component rad-component-spacing  <?php echo $layout_type.' '; ?> clearfix">
