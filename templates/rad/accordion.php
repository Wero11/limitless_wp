...
<div <?php echo join(" ",$rad_attrs) ?>>
	...
	<div class="<?php echo $joint ?>-inner-wrap" style='<?php if(isset($w['col_alignment'])) echo "text-align:".$w['col_alignment'] ?>'>
		...
		<?php $i=0; foreach ($tabs as  $tab) {
					echo ' <h3 itemprop="name" style="border:none;color:'.$tab['tab_color'].';background-color:'.$tab['tab_bgcolor'].'"><i class="icon icon-caret-down"></i> '.stripslashes($tab['tab_title']).'</h3>';
