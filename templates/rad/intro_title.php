...
$keys = implode(',',$radunits['Intro_Title']->getInputKeys());
$h = '';
...
<div <?php echo join(" ",$rad_attrs) ?>>
	<div class="<?php echo $joint ?>-inner-wrap" style='<?php if(isset($w['col_alignment'])) echo "text-align:".$w['col_alignment'] ?>'>
			...
			<div class="intro_title-title-inner-wrap"  itemscope itemtype="http://schema.org/Thing">
				<?php if(isset($w['text_subtitle'])) : ?><h4 itemprop="name" class=" text_subtitle <?php if($hidden_data['text_subtitle']) echo $hidden_data['text_subtitle']; ?> custom-font1"><?php echo $helper->format($w['text_subtitle'],true,false,false); ?></h4><?php endif; ?>
				<?php if(isset($w['text_title']) ) : ?><h2 itemprop="description" class="text_title <?php if($hidden_data['text_title']) echo $hidden_data['text_title']; ?> custom-font1"><?php echo $helper->format($w['text_title'],true,false,false); ?></h2><?php endif; ?>
			</div>	
