...
<div <?php echo join(" ",$rad_attrs) ?>>
	...
	<div class="<?php echo $joint ?>-inner-wrap" style='<?php if(isset($w['col_alignment'])) echo "text-align:".$w['col_alignment'] ?>'>
		...
		<div class="text-title-wrap"   itemscope itemtype="http://schema.org/Thing">
				...
				<?php if(isset($w['text_caption']) ) : ?><h4  class=" text_caption <?php if($hidden_data['text_caption']) echo $hidden_data['text_caption']; ?> custom-font1"><?php echo $helper->format($w['text_caption'],true,false,false); ?></h4><?php endif; ?>
			</div>
